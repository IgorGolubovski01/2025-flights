...
@Component({
  selector: 'app-order',
  imports: [MatCardModule, NgIf, NgFor, MatInputModule, MatButtonModule, MatSelectModule, MatFormFieldModule, FormsModule, NgStyle],
...
export class OrderComponent {
  ...
  public doOrder() {
    ...
    result ? this.router.navigate(['/user']) : alert('An error has occured creating an order.')
  }
}
